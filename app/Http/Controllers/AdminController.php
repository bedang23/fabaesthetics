...
class AdminController extends Controller
{
    ...
    public function saveblog(Request $request)
    {
        ...
        return redirect('admin/blog/list')->with('mesg', $mesg);
    }
    ...
    public function blogedit($id)
    {
      ...
      if(isset($value))
      {
      $edit_blog_details = Blog::where('id',$id)->first();
      return view('admin/blog/edit',compact('edit_blog_details'));
      }
      else{
          return view('admin/login');
      }
     ...
     public function updateblog(Request $request)
     {
         ...
         $newRecord = Blog::find($request->id);

         if (!$newRecord) {
             return redirect('admin/blog/list')->with('mesg', 'Record not found!');
         }
    ...
    {
        $record=Blog::where('id', $request['id'])->delete();
        return redirect('admin/blog/list')->with('msg', 'Data deleted successfully!');
     }
