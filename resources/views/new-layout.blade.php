...
<head>
   ...
   <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-YV396CZQPD"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-YV396CZQPD');
    </script>

    <meta name="google-site-verification" content="d7HHs-5r-f4iQC9k4KoR8Q7_qQ7_1LN3pDFp78QHi0c" />
      ...
      <div id="wrapper" class="fusion-wrapper">
         ...
         <header class="fusion-header-wrapper">
            <div class="fusion-header-v6 fusion-logo-alignment fusion-logo-left fusion-sticky-menu-1 fusion-sticky-logo-1 fusion-mobile-logo-  fusion-header-has-flyout-menu">
               <div class="fusion-header-sticky-height" style="height: 109px;"></div>
                     ...
                     <div class="fusion-header-v6-content fusion-header-has-flyout-menu-content">
                        <div class="fusion-logo" data-margin-top="15px" data-margin-bottom="15px" data-margin-left="0px" data-margin-right="0px">
                           <a class="fusion-logo-link" href="{{ ('/') }}">
                              ...
                              <!-- standard logo -->
                              <img src="{{ asset('assets/images/logo.png') }}"  style="max-height:70px; height:auto;" alt="Fabaesthetics Logo" data-retina_logo_url="{{ asset('assets/images/logo.png') }}" class="fusion-standard-logo" />


                              <!-- sticky header logo -->
                              <img src="{{ asset('assets/images/logo.png') }}"  style="max-height:70px; height:auto;" alt="Fabaesthetics Logo" data-retina_logo_url="{{ asset('assets/images/logo.png') }}" class="fusion-sticky-logo" />
                           </a>
                        </div>
                     ...
                     <div class="fusion-main-menu fusion-flyout-menu" role="navigation" aria-label="Main Menu">
                        <ul id="menu-main-menu" class="fusion-menu">
                           ...
                           @foreach($skinServices as $skinService)
                              <li class="menu-item menu-item-type-custom menu-item-object-custom"><a class="fusion-bar-highlight" href="{{ url('services/skin-treatment/' . $skinService->slug) }}"><span class="menu-text">{{ $skinService->title }}</span></a></li>
                           @endforeach

                           @foreach($cosmeticServices as $cosmeticService)
                              <li class="menu-item menu-item-type-custom menu-item-object-custom"><a class="fusion-bar-highlight" href="{{ url('services/cosmetic-treatment/' . $cosmeticService->slug) }}"><span class="menu-text">{{ $cosmeticService->title }}</span></a></li>
                           @endforeach

                           @foreach($hairServices as $hairService)
                              <li class="menu-item menu-item-type-custom menu-item-object-custom"><a class="fusion-bar-highlight" href="{{ url('services/hair-treatment/' . $hairService->slug) }}"><span class="menu-text">{{ $hairService->title }}</span></a></li>
                           @endforeach

                           @foreach($laserServices as $laserService)
                              <li class="menu-item menu-item-type-custom menu-item-object-custom"><a class="fusion-bar-highlight" href="{{ url('services/laser-treatment/' . $laserService->slug) }}"><span class="menu-text">{{ $laserService->title }}</span></a></li>
                           @endforeach

                           @foreach($rejuvenationServices as $rejuvenationService)
                              <li class="menu-item menu-item-type-custom menu-item-object-custom"><a class="fusion-bar-highlight" href="{{ url('services/skin-rejuvenation-treatment/' . $rejuvenationService->slug) }}"><span class="menu-text">{{ $rejuvenationService->title }}</span></a></li>
                           @endforeach

                           @foreach($makeoverServices as $makeoverService)
                              <li class="menu-item menu-item-type-custom menu-item-object-custom"><a class="fusion-bar-highlight" href="{{ url('services/make-over/' . $makeoverService->slug) }}"><span class="menu-text">{{ $makeoverService->title }}</span></a></li>
                           @endforeach
            ...
            <div class="fusion-builder-row fusion-row">
               <div class="fusion-layout-column fusion_builder_column fusion-builder-column-26 fusion_builder_column_1_1 1_1 fusion-one-full fusion-column-first fusion-column-last" style="--awb-padding-top:0px;--awb-padding-right:0px;--awb-padding-bottom:0px;--awb-padding-left:0px;--awb-bg-color:#5b5b5b;--awb-bg-color-hover:#5b5b5b;--awb-bg-size:cover;--awb-margin-bottom:25px;">
                  <div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy">
                     <div class="fusion-text fusion-text-14">
                        <h3 style="text-align: center;"><span style="color: #ffffff;">Book an appointment: <a style="color: #ffffff;" href="tel:+91-8433966645">+91-8433966645</a></span></h3>
                     </div>
                     <div class="fusion-clearfix"></div>
                  </div>
               </div>
               <div class="fusion-layout-column fusion_builder_column fusion-builder-column-27 fusion_builder_column_1_3 1_3 fusion-one-third fusion-column-first" style="--awb-padding-top:0px;--awb-padding-right:25px;--awb-padding-bottom:0px;--awb-padding-left:25px;--awb-bg-size:cover;--awb-margin-bottom:15px;width:33.333333333333%;width:calc(33.333333333333% - ( ( 4% + 4% ) * 0.33333333333333 ) );margin-right: 4%;">
                  <div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"><span style="font-size:32px;">Google Reviews</span>
                     <p style="text-align: left; font-size: 16px; margin-top:10px"><strong style="color: orange; font-size:18px">4.9</strong> <span class="rw-gl">
                           <i class="fas fa-star" style="color:orange"></i>
                           <i class="fas fa-star" style="color:orange"></i>
                           <i class="fas fa-star" style="color:orange"></i>
                           <i class="fas fa-star" style="color:orange"></i>
                           <i class="fas fa-star-half-alt" style="color:orange"></i></span> based on 195 reviews<br>
                        ...
                        So I'm from the USA, visiting friends in India. Was looking to get botox while visiting. Came across Fab Aesthetic and read the great reviews she had. So I gave it ago and made an appointment. So happy I did, very happy with the results. <br><br>
                        ...
                        <br><br>
                        <a href="https://maps.app.goo.gl/UxFP5oBspH9DALYy9" target="_blank" rel="nofollow">View more</a> on Google.
                     </p>
                     <div class="fusion-clearfix"></div>
                  </div>
               </div>
                  ...
                  <div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy">
                     <div class="fusion-text fusion-text-16">
                        <p style="font-size: 26px; text-align: center;"><strong>Call to know more</strong><br />
                           <a href="tel:+918433966645">+91-8433966645</a></p>
                     </div>
               ...
               <div class="fusion-row">
                  <div class="fusion-copyright-content">
                     ...
                     <div class="fusion-copyright-notice">
                        <div>
                           © 2024 FAB Aesthetics Clinic <br><br><br> </div>
                     </div>
   ...
   <div class="avada-footer-scripts">
      ...
      <div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3  " id="ht-ctc-chat" style="display: none;  position: fixed; bottom: 15px; right: 15px;">
         <div class="ht_ctc_style ht_ctc_chat_style">
            <div title='WhatsApp us' style="display:flex;justify-content:center;align-items:center; " class="ctc_s_3 ctc_nb" data-nb_top="-5px" data-nb_right="-5px">
               ...
               <svg style="pointer-events:none; display:block; height:50px; width:50px; margin-bottom:30px;" width="50px" height="50px" viewBox="0 0 1219.547 1225.016">
      ...
      <div id="footerfixed">
         ...
         <a href="tel:+918433966645">
            <div id="footerfixeddiv" style="font-family:'Open Sans'">Book an Appointment Call +91-8433966645</div>
         </a>
