...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>New Service</h1></div>
        <div class="col-sm-6">
      ...
      <form name="createlist" id="createlist" method="post" action="{{url('admin/service/create')}}" enctype="multipart/form-data">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <small class="form-text-help">Lowercase words separated by hyphens, e.g. <em>hydrafacial</em>.</small>
                </div>
                <div class="form-group">
        ...
        <div class="card">
          <div class="card-footer">
            <button name="submit" type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Service</button>
...
<script type="text/javascript">
  (function(){
    ...
    f.addEventListener('change', function(){ if(f.files && f.files[0]){ p.src=URL.createObjectURL(f.files[0]); p.style.display='block'; } });
  })();
</script>
@endsection
