              ...
              <div class="card-header">
                <div class="card-title">
                  ...
                  <div class="card-tools">
                      <a href="{{url('admin/blog/create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Create</a>
                  </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                      ...
                      @foreach ($record_details as $key => $value)
                        <tr>
                            ...
                            <td width="120" class="text-center">
                              ...
                              <a href="javascript:void(0);"onclick="deleteBlog({{$value['id']}})" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
